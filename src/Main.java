...
public class Main {
    public static void main(String[] args) throws InterruptedException, ExecutionException {
        Scanner scanner = new Scanner(System.in);                                                                       //Programm arbeitet mit Eingabe
        ...
        questions.addAll(List.of(
                ...
                new Question(Set.of(3), List.of("1911", "Basketball", "1886", "1897"), "Im welchem Jahr entstand das erste Automobil?", 14),
                ...
                new Question(Set.of(2, 4, 3), List.of("Mount Everest", "K2", "Kangchenjunga", "Makalu"), "Wer endeckte Amerika als erstes", 20)));
